...
const ja: Dictionary = {
  ...
  about: {
    ...
    historyTitle: "あゆみ",
    history: [
      { date: "2014.06", event: "会社設立、環境配慮型3Dプリンターフィラメントの開発に着手" },
      { date: "2014.07", event: "KOTRA「Export Gateway」参加企業に選定" },
      { date: "2014.11", event: "カナダ・ドイツ・シンガポールへ清掃用品を輸出" },
      { date: "2014.12", event: "原産地証明輸出業者の認証を取得" },
      { date: "2015.01", event: "コーヒーかすプラスチック清掃用品を発売、商標「DIRT BYE」を登録" },
      { date: "2015.02", event: "iFデザインアワード受賞（DIRT BYE）" },
      { date: "2015.05", event: "新羅大学校とファミリー企業協約、釜山グローバルフォーラムに加入" },
      { date: "2015.06", event: "中国・済南の優秀商品展に参加、オーストラリア・中国へ輸出" },
    ],
    areasTitle: "事業領域",
    areas: [
      {
      ...
      },
      {
        title: "知育玩具",
        description:
          "子どもの思考力と創造力を育む、環境にやさしい知育玩具を開発します。",
      },
    ],
  },
  productsPage: {
